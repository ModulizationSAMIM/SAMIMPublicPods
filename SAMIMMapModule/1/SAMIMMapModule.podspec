...
Pod::Spec.new do |s|
  ...
  s.name         = "SAMIMMapModule"
  s.version      = "1"
  s.summary      = "SAMIMMapModule."
  ...
  s.description  = <<-DESC
                    this is SAMIMMapModule
                   DESC

  s.homepage     = "https://github.com/ModulizationSAMIM/SAMIMMapModule"
  ...
  s.source       = { :git => "https://github.com/ModulizationSAMIM/SAMIMMapModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "SAMIMMapModule/SAMIMMapModule/**/*.{h,m}"
